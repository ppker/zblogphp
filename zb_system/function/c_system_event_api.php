 ...
 * @return array|mixed
 */
function api_GetList($count = 10, $cate = null, $auth = null, $date = null, $tags = null, $search = null, $option = null) {
	global $zbp;
	$list = array();
 ...
 * @return string
 */
function api_ViewList($page, $cate, $auth, $date, $tags, $isrewrite = false) {
	global $zbp;
 ...
 * @return string
 */
function api_ViewPost($id, $alias, $isrewrite = false) {
	global $zbp;
 ...
 * @return bool
 */
function api_ViewComments($postid, $page) {
	global $zbp;
 ...
 */
function api_PostArticle_CheckTagAndConvertIDtoString($tagnamestring) {
	global $zbp;
	$s = '';
 ...
 * @param int $id 文章ID
 */
function api_DelArticle_Comments($id) {
	global $zbp;
 ...
 * @param int $id 父评论ID
 */
function api_DelComment_Children($id) {
	global $zbp;
 ...
 */
function api_DelComment_Children_NoDel($id, &$array) {
	global $zbp;
 ...
 * @param int $id 分类ID
 */
function api_DelCategory_Articles($id) {
	global $zbp;
 ...
 * @param int $id 用户ID
 */
function api_DelMember_AllData($id) {
	global $zbp;
 ...
 */
function api_EnablePlugin($name) {
	global $zbp;
 ...
 * @param string $name 插件ID
 */
function api_DisablePlugin($name) {
	global $zbp;
 ...
 */
function api_SetTheme($theme, $style) {
	global $zbp;
 ...
 * @param $object
 */
function api_FilterMeta(&$object) {
 ...
 * @param $comment
 */
function api_FilterComment(&$comment) {
	global $zbp;
 ...
 * @param $article
 */
function api_FilterPost(&$article) {
	global $zbp;
 ...
 * @param $member
 */
function api_FilterMember(&$member) {
	global $zbp;
 ...
 * @param $module
 */
function api_FilterModule(&$module) {
	global $zbp;
 ...
 * @param $category
 */
function api_FilterCategory(&$category) {
	global $zbp;
 ...
 */
function api_CountTopArticle($addplus = null, $delplus = null) {
	global $zbp;
 ...
 */
function api_CountCommentNums($allplus = null, $chkplus = null) {
	global $zbp;
 ...
 * @param int $plus 控制是否要进行全表扫描
 */
function api_CountNormalArticleNums($plus = null) {
	global $zbp;
 ...
 * @param int $plus 控制是否要进行全表扫描
 */
function api_CountPost(&$article, $plus = null) {
	global $zbp;
 ...
 * @param int $plus 控制是否要进行全表扫描
 */
function api_CountPostArray($array, $plus = null) {
	global $zbp;
	$array = array_unique($array);
 ...
 * @param int $plus 控制是否要进行全表扫描
 */
function api_CountCategory(&$category, $plus = null) {
	global $zbp;
 ...
 * @param int $plus 控制是否要进行全表扫描
 */
function api_CountCategoryArray($array, $plus = null) {
	global $zbp;
	$array = array_unique($array);
	foreach ($array as $value) {
		if ($value == 0) {
 ...
 * @param int $plus 控制是否要进行全表扫描
 */
function api_CountTag(&$tag, $plus = null) {
	global $zbp;
 ...
 * @param int $plus 控制是否要进行全表扫描
 */
function api_CountTagArrayString($string, $plus = null, $articleid = null) {
	global $zbp;
 ...
 */
function api_CountMember(&$member, $plus = array(null, null, null, null)) {
	global $zbp;
 ...
 * @param array $plus 设置是否需要完全全表扫描
 */
function api_CountMemberArray($array, $plus = array(null, null, null, null)) {
	global $zbp;
	$array = array_unique($array);
	foreach ($array as $value) {
		if ($value == 0) {
 ...
 * @return string 模块内容
 */
function api_BuildModule_catalog() {
	global $zbp;
	$s = '';
 ...
 * @return string 模块内容
 */
function api_BuildModule_calendar($date = '') {
	global $zbp;
 ...
 * @return string 模块内容
 */
function api_BuildModule_comments() {
	global $zbp;
 ...
 * @return string 模块内容
 */
function api_BuildModule_previous() {
	global $zbp;
 ...
 * @return string 模块内容
 */
function api_BuildModule_archives() {
	global $zbp;
 ...
 * @return string 模块内容
 */
function api_BuildModule_navbar() {
	global $zbp;
 ...
 * @return string 模块内容
 */
function api_BuildModule_authors($level = 4) {
	global $zbp;
	$s = '';
 ...
 * @return string 模块内容
 */
function api_BuildModule_statistics($array = array()) {
	global $zbp;
	$all_artiles = 0;
	$all_pages = 0;
	$all_categorys = 0;
 ...
 * @param $line
 */
function api_Include_ShowError404($idortext, $file, $line) {
	global $zbp;
 ...
 */
function api_Include_AddonAdminFont() {
	global $zbp;
	$f = $s = '';
